...
plt.title("Bangalore Real Estate Price Evolution (2015–2025)")
plt.xlabel("Year")
...
# Title
# -------------------------------
st.title("📊 Bangalore Real Estate Price Evolution (2015–2025)")
st.markdown(
...
# -------------------------------
st.subheader("🚀 Long-Term Growth (CAGR %)")
...
# -------------------------------
st.subheader("⚠️ Price Volatility (Risk)")
...
# -------------------------------
# 3) Risk–Return Matrix (where to invest)
# -------------------------------
st.subheader("💼 Risk–Return Matrix (Next 10Y Signal)")
...
- Use this matrix to shortlist 2–3 micro-markets for deeper deal-level analysis over the next decade.
""")